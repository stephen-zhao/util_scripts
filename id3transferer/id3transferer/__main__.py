import argparse
from id3transferer.InfoTransferer import InfoTransferer
from id3transferer.getInfoStrategies import *
from id3transferer.setInfoStrategies import *
...
def main():
    ...
    argsParser.add_argument(
        "-i", "--in", dest="get_strat",
        choices=GetInfoStrategy.GetInfoStrategy.getStratListAbbr(),
        help="the strategy used to get info for the transfer")
    argsParser.add_argument(
        "-o", "--out", dest="set_strat",
        choices=SetInfoStrategy.SetInfoStrategy.getStratListAbbr(),
